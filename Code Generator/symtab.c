...
void 
insert(char *name, Type_Expression type, int offset, int flag) {
  int currentIndex;
  int visitedSlots = 0;
  ...
  HashTable[currentIndex]->offset = offset; /* in bytes */
	HashTable[currentIndex]->flag = flag; //is array = 1, else 0
}
